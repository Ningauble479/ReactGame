...
import { StartActions, StartScene } from '../scenes/Start.js'
...
export const GameStateArea = ({children}) => {
    ...
    return (
        <GameStateContext.Provider value={{doing, setDoing, currentAction, setCurrentAction, location, setLocation, currentPage, setCurrentPage}}>
            {children}
